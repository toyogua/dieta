<section id="reportes">
    ...
    <div style="padding-bottom: 1px;" class="row">
      <div style="padding-bottom: 1px;" class="col-md-5">
        <div style="padding-bottom: 1px;" class="md-form">
            <i style="padding-top: 40px;" class="fa fa-user prefix"></i>
                <input style="padding-top: 40px; padding-bottom: 1px;" class="text-center " type="text" id="pacientereporte" placeholder="Nombre paciente" class="pacientereporte form-control" >
        </div>
      </div>
    ...
    <div  class="col-md-4" style="padding-left: 120px; margin-top-top: 1px;" id="cargabusqueda" >
...
<!--            </div>-->
<!---->
<!--        </div> <!-- fin del row --> <!-- fin del dia martes -->
<!---->
<!---->
<!---->
...
<!--            </div>-->
<!---->
<!--        </div> <!-- fin del row --> <!-- fin del dia miercoles -->
<!---->
<!---->
...
<!--            </div>-->
<!---->
<!--        </div> <!-- fin del row --> <!-- fin del dia jueves -->
<!---->
<!---->
...
<!--            </div>-->
<!---->
<!--        </div> <!-- fin del row --> <!-- fin del dia viernes -->
<!---->
<!---->
...
<!--            </div>-->
<!---->
<!--        </div> <!-- fin del row --> <!-- fin del dia sabado -->
<!---->
...
<!--            </div>-->
<!---->
<!--        </div> <!-- fin del row --> <!-- fin del dia domingo -->
<!---->
<!---->
<!---->
<!--        <div>-->
